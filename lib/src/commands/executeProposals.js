...
async function executeProposals(proposal, dryRun = false, opts = {}) {
    const env = {
        multisigProgram: new web3_js_1.PublicKey(process.env.MULTISIG_PROGRAM || "msigmtwzgXJHj2ext4XJjCDmpbcMuufFb5cHuwg6Xdt"),
        ...opts,
    };
    await (0, batchCreate_1.batchCreateProposals)(await (0, utils_1.getMultisigContext)((0, utils_1.getProgramFromEnv)(env), proposal.multisig), proposal.transactions, dryRun);
}
